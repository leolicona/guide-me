...
// US-A21 — cancel the whole folio: releases every line's spots and records the cancellation.
export const cancelFolio = async (id: string, reason?: string): Promise<FolioDetail> => {
