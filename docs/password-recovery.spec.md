...
Solo el administrador usa contraseña en GuideMe. Cuando la olvida puede solicitar un reset por email. El flujo consta de dos pasos: solicitar el link y confirmar la nueva contraseña. Al completar el reset **no se establece sesión** — el admin debe hacer login con la nueva contraseña.
