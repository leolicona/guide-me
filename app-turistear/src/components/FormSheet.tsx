...
export interface FormSheetProps {
   ...
   *  ONE action already lives in the body (the reschedule handoff's WhatsApp send, which sends,
   *  records the send and closes in a single tap) — a footer button there is a second exit
   *  competing with the only thing worth doing. Dismissal stays the sheet contract below
   *  (puller / X / backdrop / swipe), so no footer button is not "no way out". */
  submitLabel?: string
